...
public class SQLQueries {
    ...
    public static final String STORE_AUTHORIZATION_CODE_WITH_PKCE_IDP_NAME = "INSERT INTO  " +
            ...
            "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY, CALLBACK_URL, SCOPE, AUTHZ_USER, USER_DOMAIN, TENANT_ID, " +
            "TIME_CREATED, VALIDITY_PERIOD, SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD, " +
            "AUTHORIZATION_CODE_HASH, IDP_ID) SELECT ?,?,?,?,?,?,?,?,?,?,?,?,?,?,IDP.ID " +
            "FROM IDP WHERE IDP.NAME=? AND IDP.TENANT_ID=?";
    ...
    public static final String
            ...
            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD,TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
            "GRANT_TYPE, CONSENTED_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY = ? AND AUTHZ_USER=? " +
            "AND TENANT_ID=? AND USER_DOMAIN=? " +
    ...
    public static final String
            ...
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "CONSENTED_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY = ? AND AUTHZ_USER=? AND TENANT_ID=? " +
            "AND USER_DOMAIN=? AND " +
            "TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC LIMIT 1";
    ...
    public static final String
            ...
            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "CONSENTED_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE CONSUMER_KEY = ? AND AUTHZ_USER=? " +
            "AND TENANT_ID=? AND USER_DOMAIN=? " +
            "AND TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC";
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_IDP_NAME_WITH_CONSENTED_TOKEN =
            "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN (ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY, AUTHZ_USER, " +
            ...
            "CONSENTED_TOKEN) SELECT ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,IDP.ID,?,? FROM " +
            "IDP WHERE IDP.NAME=? AND IDP.TENANT_ID=?";
