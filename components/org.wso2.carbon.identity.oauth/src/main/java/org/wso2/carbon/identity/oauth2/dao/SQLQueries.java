...
public class SQLQueries {
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME =
            "SELECT CONSUMER_KEY, AUTHZ_USER_ID, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    ...
                    "  AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID AS TENANT_ID, " +
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER_ID, " +
            ...
            "FROM (SELECT TOKEN_ID, CONSUMER_KEY, AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID, " +
    ...
    public static final String GET_ACCESS_TOKENS_BY_BINDING_REFERENCE_AND_USER = "SELECT ACCESS_TOKEN, CONSUMER_KEY, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER_ID = ?" + " AND TENANT_ID = ? " +
    ...
    public static final String GET_ACCESS_TOKENS_BY_BINDING_REFERENCE = "SELECT ACCESS_TOKEN, CONSUMER_KEY, " +
            ...
            "TOKEN_ID, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, USER_TYPE, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TENANT_ID, AUTHZ_USER_ID , USER_DOMAIN, IDP_ID FROM IDN_OAUTH2_ACCESS_TOKEN " +
    ...
    public static final String GET_ACCESS_TOKEN_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, USER_TYPE " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND TOKEN_STATE=? AND USER_DOMAIN=?";
    ...
    public static final String GET_OPEN_ID_ACCESS_TOKEN_DATA_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND " +
    ...
    public static final String GET_ACTIVE_DETAILS_FOR_CONSUMER_KEY = "SELECT IDN_OAUTH2_ACCESS_TOKEN.AUTHZ_USER_ID, " +
    ...
    public static final String GET_ACTIVE_DETAILS_FOR_CONSUMER_KEY_IDP_NAME = "SELECT IDN_OAUTH2_ACCESS_TOKEN" +
            ".AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN.ACCESS_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID, " +
    ...
    public static final String GET_AUTHORIZATION_CODES_BY_AUTHZUSER = "SELECT DISTINCT AUTHORIZATION_CODE, " +
            ...
            " FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND STATE=?";
    ...
    public static final String GET_OPEN_ID_AUTHORIZATION_CODE_DATA_BY_AUTHZUSER = "SELECT DISTINCT " +
            ...
            "IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY_ID=IDN_OAUTH_CONSUMER_APPS.ID WHERE AUTHZ_USER_ID=? AND " +
    ...
    public static final String GET_DISTINCT_APPS_AUTHORIZED_BY_USER_ALL_TIME = "SELECT DISTINCT CONSUMER_KEY FROM " +
            ...
            "ID WHERE AUTHZ_USER_ID=? AND IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID=? AND IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN=? " +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_USER_DOMAIN = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            "CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER_ID, IDN_OAUTH2_AUTHORIZATION_CODE.SCOPE, " +
            "TIME_CREATED, VALIDITY_PERIOD, IDN_OAUTH2_AUTHORIZATION_CODE.CALLBACK_URL FROM (SELECT " +
            "AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE, MAX(TIME_CREATED) TIMES FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE " +
            "TENANT_ID=? AND USER_DOMAIN=? group by AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE) AUTHZ_SELECTED JOIN " +
            "IDN_OAUTH2_AUTHORIZATION_CODE ON AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER_ID " +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_TENANT = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            ...
            "FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE TENANT_ID=? group by AUTHZ_USER_ID, " +
            "USER_DOMAIN, CONSUMER_KEY_ID, SCOPE) AUTHZ_SELECTED JOIN IDN_OAUTH2_AUTHORIZATION_CODE ON " +
            "AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER_ID AND AUTHZ_SELECTED" +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_TENANT_IDP_NAME = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            ...
            "TIMES, IDP_ID FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE TENANT_ID=? GROUP BY AUTHZ_USER_ID, " +
            "USER_DOMAIN, CONSUMER_KEY_ID, SCOPE, IDP_ID) AUTHZ_SELECTED JOIN IDN_OAUTH2_AUTHORIZATION_CODE ON " +
            "AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER_ID AND AUTHZ_SELECTED.CONSUMER_KEY_ID=" +
