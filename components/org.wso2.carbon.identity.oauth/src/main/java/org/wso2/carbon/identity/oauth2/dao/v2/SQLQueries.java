...
public class SQLQueries {
    ...
    public static final String STORE_AUTHORIZATION_CODE = "INSERT INTO IDN_OAUTH2_AUTHORIZATION_CODE_V2 " +
            "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE, AUTHZ_USER_ID, USER_DOMAIN, " +
            "TENANT_ID, TIME_CREATED, VALIDITY_PERIOD, SUBJECT_IDENTIFIER, AUTHORIZATION_CODE_HASH) SELECT ?,?,ID,?," +
            "?,?,?,?,?,?,?,? FROM " + "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=?";
    
    public static final String STORE_AUTHORIZATION_CODE_WITH_PKCE = "INSERT INTO  IDN_OAUTH2_AUTHORIZATION_CODE_V2 " +
            "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE, AUTHZ_USER_ID, USER_DOMAIN, " +
            "TENANT_ID, TIME_CREATED, VALIDITY_PERIOD, SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, " +
            "PKCE_CODE_CHALLENGE_METHOD, AUTHORIZATION_CODE_HASH) " + "SELECT ?,?,ID,?,?,?,?,?,?,?,?,?,?,? FROM " +
    ...
    public static final String STORE_AUTHORIZATION_CODE_WITH_PKCE_IDP_NAME = "INSERT INTO  " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 " +
            "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE, AUTHZ_USER_ID, USER_DOMAIN, " +
            "TENANT_ID, TIME_CREATED, VALIDITY_PERIOD, SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, " +
            "PKCE_CODE_CHALLENGE_METHOD, AUTHORIZATION_CODE_HASH, IDP_ID) SELECT ?,?,IDN_OAUTH_CONSUMER_APPS.ID," +
            "?,?,?,?,?,?,?,?,?,?,?,IDP.ID " +
            "FROM IDN_OAUTH_CONSUMER_APPS, IDP WHERE CONSUMER_KEY=? AND IDP.NAME=? AND IDP.TENANT_ID=?";

    public static final String VALIDATE_AUTHZ_CODE = "SELECT AUTHZ_USER_ID, USER_DOMAIN, TENANT_ID, SCOPE, " +
            "CALLBACK_URL, TIME_CREATED,VALIDITY_PERIOD, STATE, TOKEN_ID, AUTHORIZATION_CODE, CODE_ID, " +
            "SUBJECT_IDENTIFIER FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHORIZATION_CODE_HASH = ?";

    public static final String VALIDATE_AUTHZ_CODE_WITH_PKCE = "SELECT AUTHZ_USER_ID, USER_DOMAIN, TENANT_ID, SCOPE, " +
            "CALLBACK_URL, TIME_CREATED,VALIDITY_PERIOD, STATE, TOKEN_ID, AUTHORIZATION_CODE, CODE_ID, " +
            "SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND "
            + "AUTHORIZATION_CODE_HASH = ?";

    public static final String VALIDATE_AUTHZ_CODE_WITH_PKCE_IDP_NAME = "SELECT AUTHZ_USER_ID, USER_DOMAIN, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.TENANT_ID, SCOPE, CALLBACK_URL, TIME_CREATED,VALIDITY_PERIOD, STATE, " +
            "TOKEN_ID, AUTHORIZATION_CODE, CODE_ID, SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, " +
            "PKCE_CODE_CHALLENGE_METHOD, IDP.NAME FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 " +
            "INNER JOIN IDP ON IDP_ID=IDP.ID AND IDN_OAUTH2_AUTHORIZATION_CODE_V2.TENANT_ID=IDP.TENANT_ID WHERE " +
    ...
    public static final String RETRIEVE_CODE_ID_BY_AUTHORIZATION_CODE = "SELECT CODE_ID FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE AUTHORIZATION_CODE_HASH = ?";

    public static final String RETRIEVE_AUTHZ_CODE_BY_CODE_ID = "SELECT AUTHORIZATION_CODE FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE CODE_ID = ?";

    public static final String RETRIEVE_TOKEN_ID_BY_TOKEN = "SELECT TOKEN_ID FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN_HASH = ?";

    public static final String RETRIEVE_TOKEN_BY_TOKEN_ID = "SELECT ACCESS_TOKEN FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TOKEN_ID = ?";

    public static final String UPDATE_TOKEN_AGAINST_AUTHZ_CODE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET " +
    ...
    public static final String GET_ACCESS_TOKEN_BY_AUTHZ_CODE = "SELECT AUTHORIZATION_CODE FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE TOKEN_ID=?";

    public static final String UPDATE_NEW_TOKEN_AGAINST_AUTHZ_CODE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET " +
            "TOKEN_ID=? WHERE TOKEN_ID=?";

    public static final String DEACTIVATE_AUTHZ_CODE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET " +
            "STATE='INACTIVE' WHERE AUTHORIZATION_CODE= ?";

    public static final String EXPIRE_AUTHZ_CODE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET " +
            "STATE='EXPIRED' WHERE AUTHORIZATION_CODE= ?";

    public static final String DEACTIVATE_AUTHZ_CODE_AND_INSERT_CURRENT_TOKEN =
            "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET STATE='INACTIVE', TOKEN_ID=? WHERE AUTHORIZATION_CODE_HASH= ?";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE = "SELECT * FROM (SELECT " +
            ...
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID=(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND " +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MYSQL = "SELECT ACCESS_TOKEN, " +
            ...
            " TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? " +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MYSQL = "SELECT " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL = "SELECT " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID= (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? " +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MSSQL = "SELECT TOP 1 " +
            "ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WITH (NOLOCK) WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS" +
            " " +
            "WHERE CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND" +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL = "SELECT TOP 1 " +
            ...
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WITH (NOLOCK) WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS" +
            " " +
            "WHERE CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? " +
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFORMIX = "SELECT " +
            ...
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? " +
            "AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID) ORDER BY TIME_CREATED DESC) TOKEN ";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            " IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_STATE='ACTIVE') " +
            "ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER_IDP_NAME = "SELECT ACCESS_TOKEN, " +
            ...
            + "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF FROM" +
            " IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_STATE='ACTIVE' AND " +
            "IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID)) " +
            "ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_BY_CLIENT_ID_USER = "SELECT ACCESS_TOKEN, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF FROM" +
            " IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND (TOKEN_STATE='ACTIVE' OR " +
            "TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE" +
            ".TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_BY_CLIENT_ID_USER_IDP_NAME = "SELECT " +
            ...
            "IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID)) " +
            "ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON " +
            "ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER_ID, " +
            ...
            "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF FROM (SELECT TOKEN_ID, CONSUMER_KEY, AUTHZ_USER_ID, " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID AS TENANT_ID, IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN AS USER_DOMAIN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.GRANT_TYPE AS GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF " +
            "FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN_HASH=? AND TOKEN_STATE='ACTIVE') " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
            " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME =
            "SELECT CONSUMER_KEY, AUTHZ_USER_ID, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    ...
                    "  AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID AS TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN AS USER_DOMAIN,TIME_CREATED," +
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
                    "REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.GRANT_TYPE AS GRANT_TYPE," +
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN_V2.IDP_ID AS IDP_ID, TOKEN_BINDING_REF " +
                    "FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN_HASH=? AND " +
                    "TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN_V2 " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
                    " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
                    "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID JOIN IDP ON IDP_ID = IDP.ID";

    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_TABLE.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
            "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF " +
            "FROM (SELECT TOKEN_ID, CONSUMER_KEY, AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID, " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID " +
            "WHERE ACCESS_TOKEN_HASH=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE LEFT " +
            "JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_IDP_NAME = "SELECT CONSUMER_KEY, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_TABLE.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
            ...
            "IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN_V2.IDP_ID, TOKEN_BINDING_REF " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID " +
            "WHERE ACCESS_TOKEN_HASH=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE LEFT " +
            "JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID " +
    ...
    public static final String UPDATE_TOKEN_STATE = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET TOKEN_STATE=?, " +
            "TOKEN_STATE_ID=? WHERE TOKEN_ID=?";
    @Deprecated
    public static final String UPDATE_TOKE_STATE = UPDATE_TOKEN_STATE;

    public static final String REVOKE_ACCESS_TOKEN_BY_TOKEN_ID = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET TOKEN_STATE=?, " +
            "TOKEN_STATE_ID=? WHERE TOKEN_ID=?";

    public static final String REVOKE_ACCESS_TOKEN = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET TOKEN_STATE=?, " +
            "TOKEN_STATE_ID=? WHERE ACCESS_TOKEN_HASH=?";

    public static final String REVOKE_APP_ACCESS_TOKEN = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET TOKEN_STATE=?, " +
            "TOKEN_STATE_ID=? WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND TOKEN_STATE=?";

    public static final String REVOKE_REFRESH_TOKEN = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET TOKEN_STATE=?, " +
    ...
    public static final String GET_ACCESS_TOKENS_BY_BINDING_REFERENCE_AND_USER = "SELECT ACCESS_TOKEN, CONSUMER_KEY, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE AUTHZ_USER_ID = ?" + " AND TENANT_ID = ? " +
            ...
            "JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String GET_ACCESS_TOKENS_BY_BINDING_REFERENCE = "SELECT ACCESS_TOKEN, CONSUMER_KEY, " +
            "TOKEN_SCOPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, ACCESS_TOKEN_TABLE.TENANT_ID, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_TABLE.USER_DOMAIN, IDP_ID FROM (SELECT ACCESS_TOKEN, CONSUMER_KEY_ID, " +
            "TOKEN_ID, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, USER_TYPE, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TENANT_ID, AUTHZ_USER_ID , USER_DOMAIN, IDP_ID FROM IDN_OAUTH2_ACCESS_TOKEN_V2 " +
    ...
    public static final String GET_ACCESS_TOKEN_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, USER_TYPE " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND TOKEN_STATE=? AND USER_DOMAIN=?";
    ...
    public static final String GET_OPEN_ID_ACCESS_TOKEN_DATA_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND " +
            "TOKEN_STATE=? AND USER_DOMAIN=?) ACCESS_TOKEN_TABLE JOIN IDN_OAUTH_CONSUMER_APPS ON " +
            "ID = CONSUMER_KEY_ID " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID WHERE TOKEN_SCOPE=?";

    public static final String GET_ACCESS_TOKENS_FOR_CONSUMER_KEY = "SELECT ACCESS_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN_V2" +
            " WHERE CONSUMER_KEY_ID IN (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? ) AND " +
            "TOKEN_STATE=?";

    public static final String GET_ACTIVE_DETAILS_FOR_CONSUMER_KEY = "SELECT IDN_OAUTH2_ACCESS_TOKEN_V2.AUTHZ_USER_ID, " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2.ACCESS_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID, " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN, IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_SCOPE " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON IDN_OAUTH2_ACCESS_TOKEN_V2.TOKEN_ID=IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=?) AND TOKEN_STATE=?";

    public static final String GET_ACTIVE_DETAILS_FOR_CONSUMER_KEY_IDP_NAME = "SELECT IDN_OAUTH2_ACCESS_TOKEN_V2" +
            ".AUTHZ_USER_ID, IDN_OAUTH2_ACCESS_TOKEN_V2.ACCESS_TOKEN, IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID, " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN, IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_SCOPE, IDP.NAME FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2" +
            " ON IDN_OAUTH2_ACCESS_TOKEN_V2.TOKEN_ID=IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID " +
            " JOIN  IDP ON IDN_OAUTH2_ACCESS_TOKEN_V2.IDP_ID=IDP.ID WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=?) AND TOKEN_STATE=?";

    public static final String GET_AUTHORIZATION_CODES_FOR_CONSUMER_KEY = "SELECT AUTHORIZATION_CODE   FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE CONSUMER_KEY_ID IN (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) ";
    ...
    public static final String UPDATE_AUTHORIZATION_CODE_STATE_FOR_CONSUMER_KEY = "UPDATE "
            + "IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET STATE=? WHERE CONSUMER_KEY_ID IN (SELECT ID FROM "
            + "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?)";

    public static final String UPDATE_AUTHORIZATION_CODE_STATE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2 SET STATE=? " +
    ...
    public static final String GET_AUTHORIZATION_CODES_BY_AUTHZUSER = "SELECT DISTINCT AUTHORIZATION_CODE, " +
            ...
            " FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND STATE=?";
    ...
    public static final String GET_OPEN_ID_AUTHORIZATION_CODE_DATA_BY_AUTHZUSER = "SELECT DISTINCT " +
            ...
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.CALLBACK_URL, CONSUMER_KEY " +
            "FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 JOIN IDN_OAUTH_CONSUMER_APPS ON " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID=IDN_OAUTH_CONSUMER_APPS.ID WHERE AUTHZ_USER_ID=? AND " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.TENANT_ID=? AND IDN_OAUTH2_AUTHORIZATION_CODE_V2.USER_DOMAIN=? AND " +
    ...
    public static final String GET_DISTINCT_APPS_AUTHORIZED_BY_USER_ALL_TIME = "SELECT DISTINCT CONSUMER_KEY FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = " +
            "ID WHERE AUTHZ_USER_ID=? AND IDN_OAUTH2_ACCESS_TOKEN_V2.TENANT_ID=? AND IDN_OAUTH2_ACCESS_TOKEN_V2.USER_DOMAIN=? " +
            "AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_MYSQL = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            ...
            "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND " +
            "REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC, TOKEN_STATE LIMIT 1) ACCESS_TOKEN_SELECTED LEFT JOIN " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_MYSQL = "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER_ID, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            ...
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF FROM" +
            " IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS " +
            "WHERE CONSUMER_KEY = ?) " +
            "AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC, TOKEN_STATE LIMIT 1) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 " +
            "ON ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID " +
            "JOIN IDP ON IDP_ID=IDP.ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_DB2SQL = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM ( " +
            "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD," +
            " TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_DB2SQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, IDP.NAME " +
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD," +
            " TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF FROM IDN_OAUTH2_ACCESS_TOKEN_V2 " +
                    "WHERE " +
            "CONSUMER_KEY_ID = " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_ORACLE = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM ( " +
            "SELECT * FROM (SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            ...
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_ORACLE =
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, IDP.NAME " +
            "FROM (SELECT * FROM (SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID JOIN IDP ON IDP_ID=IDP.ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_MSSQL = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM " +
            "(SELECT TOP 1 ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_SELECTED" +
            ".TOKEN_ID  = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_MSSQL = "SELECT ACCESS_TOKEN, " +
            ...
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, IDP.NAME " +
            "FROM (SELECT TOP 1 ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_SELECTED" +
            ".TOKEN_ID  = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID JOIN IDP ON IDP_ID=IDP.ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_POSTGRESQL = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM " +
            "(SELECT ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2" +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_INFORMIX = "SELECT ACCESS_TOKEN, AUTHZ_USER_ID, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF FROM ( " +
            "SELECT FIRST 1 ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2" +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) " +
            "AND REFRESH_TOKEN_HASH = ? " +
            "ORDER BY TIME_CREATED DESC) ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON " +
            "ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_INFORMIX = "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER_ID, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, IDP.NAME " +
            "FROM (SELECT FIRST 1 ACCESS_TOKEN, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF FROM IDN_OAUTH2_ACCESS_TOKEN_V2" +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) " +
            "AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON " +
            "ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID " +
            "JOIN IDP ON IDP_ID=IDP.ID";

    public static final String RETRIEVE_OLD_TOKEN_BY_TOKEN_HASH = "SELECT TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, " +
            "CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, USER_TYPE, GRANT_TYPE, TIME_CREATED, " +
            ...
            "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN_HASH = ?";

    public static final String RETRIEVE_OLD_TOKEN_BY_TOKEN_HASH_WITH_IDP_NAME = "SELECT TOKEN_ID, ACCESS_TOKEN, " +
            "REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, USER_TYPE, GRANT_TYPE, TIME_CREATED," +
            " REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
            "TOKEN_STATE, TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH, IDP_ID  FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN_HASH = ?";

    public static final String INSERT_OAUTH2_ACCESS_TOKEN = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_V2(ACCESS_TOKEN, " +
            "REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_IDP_NAME = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_V2" +
            "(ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
            "TOKEN_STATE, USER_TYPE, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH," +
            "IDP_ID, TOKEN_BINDING_REF) SELECT ?,?,IDN_OAUTH_CONSUMER_APPS.ID,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,IDP.ID,? "
            + "FROM IDN_OAUTH_CONSUMER_APPS, IDP WHERE CONSUMER_KEY=? AND IDP.NAME=? AND IDP.TENANT_ID=?";

    public static final String INSERT_OAUTH2_TOKEN_SCOPE = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 (TOKEN_ID, " +
            "TOKEN_SCOPE, TENANT_ID) VALUES (?,?,?)";
    public static final String INSERT_OAUTH2_CODE_SCOPE = "INSERT INTO IDN_OAUTH2_AUTHZ_CODE_SCOPE_V2 (CODE_ID, " +
            "SCOPE, TENANT_ID) VALUES (?,?,?)";
    public static final String GET_OAUTH2_CODE_SCOPE = "SELECT SCOPE FROM IDN_OAUTH2_AUTHZ_CODE_SCOPE_V2 WHERE " +
            "CODE_ID=? AND TENANT_ID=?";

    public static final String STORE_OLD_TOKEN_IN_AUDIT = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_AUDIT_V2 " +
            "(TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, USER_TYPE, " +
    ...
    public static final String STORE_OLD_TOKEN_IN_AUDIT_WITH_IDP_NAME = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_AUDIT_V2 " +
            "(TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, " +
            "USER_TYPE, " +
            "GRANT_TYPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, " +
            "TOKEN_SCOPE_HASH, TOKEN_STATE, TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, " +
    ...
    public static final String RETRIEVE_AND_STORE_IN_AUDIT =
            "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_AUDIT_V2 (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, " +
                    "AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, USER_TYPE, GRANT_TYPE, TIME_CREATED, " +
                    ...
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
                    "TOKEN_STATE, TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH, ? " +
                    "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TOKEN_ID = ?";

    public static final String RETRIEVE_AND_STORE_IN_AUDIT_WITH_IDP_NAME = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_AUDIT_V2" +
            " (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, USER_TYPE," +
            " GRANT_TYPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, " +
            "TOKEN_SCOPE_HASH, TOKEN_STATE, TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, " +
    ...
    public static final String DELETE_OLD_TOKEN_BY_ID = "DELETE FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TOKEN_ID = ?";

    public static final String DELETE_ACCESS_TOKEN = "DELETE FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE ACCESS_TOKEN = ? ";

    public static final String REVOKE_SAAS_TOKENS_OF_OTHER_TENANTS = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2" +
    ...
    public static final String RENAME_USER_STORE_IN_ACCESS_TOKENS_TABLE = "UPDATE IDN_OAUTH2_ACCESS_TOKEN_V2 SET " +
            "USER_DOMAIN=? WHERE TENANT_ID=? AND USER_DOMAIN=?";

    public static final String RENAME_USER_STORE_IN_AUTHORIZATION_CODES_TABLE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
    ...
    public static final String LIST_ALL_TOKENS_IN_TENANT = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "TOKEN_SCOPE, ACCESS_TOKEN_TABLE.TOKEN_ID, AUTHZ_USER_ID, ACCESS_TOKEN_TABLE.USER_DOMAIN, CONSUMER_KEY FROM " +
            "(SELECT AUTHZ_USER_ID, USER_DOMAIN, CONSUMER_KEY_ID, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TENANT_ID=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) " +
            "ACCESS_TOKEN_TABLE JOIN IDN_OAUTH_CONSUMER_APPS ON ID = CONSUMER_KEY_ID LEFT JOIN " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String LIST_ALL_TOKENS_IN_TENANT_IDP_NAME = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "TOKEN_SCOPE, ACCESS_TOKEN_TABLE.TOKEN_ID, AUTHZ_USER_ID, ACCESS_TOKEN_TABLE.USER_DOMAIN, CONSUMER_KEY, " +
            "IDP.NAME FROM " +
            "(SELECT AUTHZ_USER_ID, USER_DOMAIN, CONSUMER_KEY_ID, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, " +
    ...
    public static final String LIST_ALL_TOKENS_IN_USER_STORE = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "TOKEN_SCOPE, ACCESS_TOKEN_TABLE.TOKEN_ID, AUTHZ_USER_ID, CONSUMER_KEY FROM (SELECT AUTHZ_USER_ID, " +
            "CONSUMER_KEY_ID, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TENANT_ID=?" +
            " AND USER_DOMAIN=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE JOIN " +
            "IDN_OAUTH_CONSUMER_APPS ON ID = CONSUMER_KEY_ID LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON " +
            "ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";

    public static final String LIST_ALL_TOKENS_IN_USER_STORE_IDP_NAME = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "TOKEN_SCOPE, ACCESS_TOKEN_TABLE.TOKEN_ID, AUTHZ_USER_ID, CONSUMER_KEY, IDP.NAME FROM (SELECT AUTHZ_USER_ID, " +
            "CONSUMER_KEY_ID, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, IDP_ID FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE " +
            "TENANT_ID=?" +
            " AND USER_DOMAIN=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE JOIN " +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_USER_DOMAIN = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            "CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID, IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE, " +
            "TIME_CREATED, VALIDITY_PERIOD, IDN_OAUTH2_AUTHORIZATION_CODE_V2.CALLBACK_URL FROM (SELECT " +
            "AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE, MAX(TIME_CREATED) TIMES FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE " +
            "TENANT_ID=? AND USER_DOMAIN=? group by AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE) AUTHZ_SELECTED JOIN " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 ON AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID " +
            "AND AUTHZ_SELECTED.CONSUMER_KEY_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID AND AUTHZ_SELECTED" +
            ".TIMES=IDN_OAUTH2_AUTHORIZATION_CODE_V2.TIME_CREATED AND AUTHZ_SELECTED.SCOPE=IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
            ".SCOPE JOIN IDN_OAUTH_CONSUMER_APPS ON IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID = ID WHERE " +
            "STATE='ACTIVE'";

    public static final String LIST_LATEST_AUTHZ_CODES_IN_USER_DOMAIN_IDP_NAME = "SELECT CODE_ID, AUTHORIZATION_CODE," +
            "CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID, IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE, " +
            "TIME_CREATED, VALIDITY_PERIOD, IDN_OAUTH2_AUTHORIZATION_CODE_V2.CALLBACK_URL, " +
            "IDP.NAME FROM (SELECT AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE, MAX(TIME_CREATED) TIMES, IDP_ID FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE " +
            "TENANT_ID=? AND USER_DOMAIN=? GROUP BY AUTHZ_USER_ID, CONSUMER_KEY_ID, SCOPE, IDP_ID) AUTHZ_SELECTED JOIN " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2 ON AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID " +
            "AND AUTHZ_SELECTED.CONSUMER_KEY_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID AND AUTHZ_SELECTED" +
            ".TIMES=IDN_OAUTH2_AUTHORIZATION_CODE_V2.TIME_CREATED AND AUTHZ_SELECTED.SCOPE=IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
            ".SCOPE JOIN IDN_OAUTH_CONSUMER_APPS ON IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID = " +
            "IDN_OAUTH_CONSUMER_APPS.ID JOIN IDP ON IDN_OAUTH2_AUTHORIZATION_CODE_V2.IDP_ID = IDP.ID " +
            "WHERE STATE='ACTIVE'";

    public static final String LIST_LATEST_AUTHZ_CODES_IN_TENANT = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            "CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID, IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE, " +
            "TIME_CREATED, VALIDITY_PERIOD, IDN_OAUTH2_AUTHORIZATION_CODE_V2.CALLBACK_URL, IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
            ".USER_DOMAIN FROM (SELECT AUTHZ_USER_ID, USER_DOMAIN, CONSUMER_KEY_ID, SCOPE, MAX(TIME_CREATED) TIMES " +
            "FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE TENANT_ID=? group by AUTHZ_USER_ID, " +
            "USER_DOMAIN, CONSUMER_KEY_ID, SCOPE) AUTHZ_SELECTED JOIN IDN_OAUTH2_AUTHORIZATION_CODE_V2 ON " +
            "AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID AND AUTHZ_SELECTED" +
            ".CONSUMER_KEY_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID AND AUTHZ_SELECTED" +
            ".TIMES=IDN_OAUTH2_AUTHORIZATION_CODE_V2.TIME_CREATED AND AUTHZ_SELECTED" +
            ".USER_DOMAIN=IDN_OAUTH2_AUTHORIZATION_CODE_V2.USER_DOMAIN AND AUTHZ_SELECTED" +
            ".SCOPE=IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE JOIN IDN_OAUTH_CONSUMER_APPS ON IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_TENANT_IDP_NAME = "SELECT CODE_ID, AUTHORIZATION_CODE, " +
            "CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID, IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE, " +
            "TIME_CREATED, VALIDITY_PERIOD, IDN_OAUTH2_AUTHORIZATION_CODE_V2.CALLBACK_URL, IDN_OAUTH2_AUTHORIZATION_CODE_V2" +
            ".USER_DOMAIN, IDP.NAME FROM (SELECT AUTHZ_USER_ID, USER_DOMAIN, CONSUMER_KEY_ID, SCOPE, MAX(TIME_CREATED) " +
            "TIMES, IDP_ID FROM IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE TENANT_ID=? GROUP BY AUTHZ_USER_ID, " +
            "USER_DOMAIN, CONSUMER_KEY_ID, SCOPE, IDP_ID) AUTHZ_SELECTED JOIN IDN_OAUTH2_AUTHORIZATION_CODE_V2 ON " +
            "AUTHZ_SELECTED.AUTHZ_USER_ID=IDN_OAUTH2_AUTHORIZATION_CODE_V2.AUTHZ_USER_ID AND AUTHZ_SELECTED.CONSUMER_KEY_ID=" +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID AND AUTHZ_SELECTED.TIMES=" +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.TIME_CREATED AND AUTHZ_SELECTED.USER_DOMAIN=" +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.USER_DOMAIN AND AUTHZ_SELECTED.SCOPE=" +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.SCOPE JOIN IDN_OAUTH_CONSUMER_APPS ON " +
            "IDN_OAUTH2_AUTHORIZATION_CODE_V2.CONSUMER_KEY_ID = IDN_OAUTH_CONSUMER_APPS.ID " +
            "JOIN IDP ON IDN_OAUTH2_AUTHORIZATION_CODE_V2.IDP_ID = IDP.ID WHERE STATE='ACTIVE'";
    ...
    public static final String RETRIEVE_LATEST_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MYSQL = "SELECT " +
            "ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER FROM IDN_OAUTH2_ACCESS_TOKEN_V2 " +
            "WHERE CONSUMER_KEY_ID =(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER_ID=? " +
    ...
    public static final String RETRIEVE_LATEST_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE = "SELECT * FROM " +
            ...
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID=(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY" +
            " = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND TOKEN_STATE='ACTIVE'" +
    ...
    public static final String RETRIEVE_LATEST_NON_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE = "SELECT * " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE CONSUMER_KEY_ID=(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY" +
            " = ?) AND AUTHZ_USER_ID=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND " +
    ...
    public static final String RETRIEVE_REFRESH_TOKEN =
            ...
            "FROM (SELECT TOKEN_ID, " +
                    ...
                    "FROM (SELECT * " +
                        "FROM IDN_OAUTH2_ACCESS_TOKEN_V2 " +
                        "WHERE REFRESH_TOKEN_HASH = ? AND TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN_V2 " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID";
    ...
    public static final String RETRIEVE_REFRESH_TOKEN_WITH_IDP_NAME =
            ...
            "FROM (SELECT TOKEN_ID, " +
                    ...
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID JOIN IDP ON IDP.ID = IDP_ID";

    public static final String RETRIEVE_TOKEN_BINDING_BY_TOKEN_ID = "SELECT TOKEN_BINDING_TYPE, "
            + "TOKEN_BINDING_REF, TOKEN_BINDING_VALUE FROM IDN_OAUTH2_TOKEN_BINDING_V2 WHERE TOKEN_ID = ?";

    public static final String RETRIEVE_TOKENS_MAPPED_FOR_TOKEN_BINDING_VALUE = "SELECT TOKEN_ID FROM " +
            "IDN_OAUTH2_TOKEN_BINDING_V2 WHERE TOKEN_BINDING_VALUE = ? AND TOKEN_BINDING_TYPE = ?";

    public static final String RETRIEVE_TOKEN_BINDING_REF_EXISTS = "SELECT COUNT(*) AS TOTAL FROM "
            + "IDN_OAUTH2_TOKEN_BINDING_V2 WHERE TOKEN_BINDING_REF = ?";

    public static final String STORE_TOKEN_BINDING = "INSERT INTO IDN_OAUTH2_TOKEN_BINDING_V2 (TOKEN_ID, "
            + "TOKEN_BINDING_TYPE, TOKEN_BINDING_REF, TOKEN_BINDING_VALUE, TENANT_ID) VALUES (?, ?, ?, ?, ?)";

    public static final String DELETE_TOKEN_BINDING_BY_TOKEN_ID = "DELETE FROM IDN_OAUTH2_TOKEN_BINDING_V2 WHERE "
            + "TOKEN_ID = ?";

    public static final String RETRIEVE_TOKEN_BINDING_REFERENCE_TOKEN_ID = "SELECT TOKEN_BINDING_REF FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE TOKEN_ID = ? AND TENANT_ID = ?";
    ...
    public static final String GET_ACCESS_TOKENS_AND_TOKEN_IDS_FOR_CONSUMER_KEY = "SELECT DISTINCT ACCESS_TOKEN, "
            ...
            + "GRANT_TYPE, CONSUMER_KEY_ID, TOKEN_ID, TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_TIME_CREATED, "
            + "REFRESH_TOKEN_VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN_V2 WHERE "
            + "CONSUMER_KEY_ID IN (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? ) AND TOKEN_STATE=?) "
            + "ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 ON "
            + "ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2.TOKEN_ID " + "WHERE TOKEN_SCOPE=?";
    ...
    public static final String GET_DETAILED_ACTIVE_AUTHORIZATION_CODES_FOR_CONSUMER_KEY =
            "SELECT AUTHORIZATION_CODE, CODE_ID, TIME_CREATED, VALIDITY_PERIOD, SCOPE FROM "
                    + "IDN_OAUTH2_AUTHORIZATION_CODE_V2 WHERE CONSUMER_KEY_ID IN "
